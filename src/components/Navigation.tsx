              ...
              <motion.div className="flex flex-col space-y-4">
                {navLinks.map((link, i) => (
                  <motion.a
                    ...
                    className="text-xl py-3 px-4 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                  >
                    {link.name}
                  </motion.a>
                ))}
                <motion.button 
                  className="mt-4 w-full py-3 bg-lime-400/10 hover:bg-lime-400/20 text-lime-400 rounded-lg border border-lime-400/20 transition-all duration-300 font-medium"
                  variants={mobileLinkVariants}
                >
                  Get in Touch
                </motion.button>
